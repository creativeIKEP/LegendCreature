...
extern "C"  float TerrainData_GetInterpolatedHeight_m2720996942 (TerrainData_t657004131 * __this, float ___x0, float ___y1, const RuntimeMethod* method)
{
	typedef float (*TerrainData_GetInterpolatedHeight_m2720996942_ftn) (TerrainData_t657004131 *, float, float);
	static TerrainData_GetInterpolatedHeight_m2720996942_ftn _il2cpp_icall_func;
	if (!_il2cpp_icall_func)
	_il2cpp_icall_func = (TerrainData_GetInterpolatedHeight_m2720996942_ftn)il2cpp_codegen_resolve_icall ("UnityEngine.TerrainData::GetInterpolatedHeight(System.Single,System.Single)");
