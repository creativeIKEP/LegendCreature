...
extern "C"  void Rigidbody_AddForce_m1059068722 (Rigidbody_t3916780224 * __this, Vector3_t3722313464  ___force0, int32_t ___mode1, const RuntimeMethod* method) IL2CPP_METHOD_ATTR;
...
extern "C"  Vector3_t3722313464  CharacterController_get_velocity_m3517335080 (CharacterController_t1138636865 * __this, const RuntimeMethod* method)
{
	...
	memset(&V_1, 0, sizeof(V_1));
	{
		CharacterController_INTERNAL_get_velocity_m2491100652(__this, (Vector3_t3722313464 *)(&V_0), /*hidden argument*/NULL);
		Vector3_t3722313464  L_0 = V_0;
		V_1 = L_0;
		goto IL_0010;
	}
...
extern "C"  bool Physics_Linecast_m2155187179 (RuntimeObject * __this /* static, unused */, Vector3_t3722313464  ___start0, Vector3_t3722313464  ___end1, RaycastHit_t1056001966 * ___hitInfo2, int32_t ___layerMask3, const RuntimeMethod* method)
{
	int32_t V_0 = 0;
	bool V_1 = false;
	{
		...
		int32_t L_3 = ___layerMask3;
		int32_t L_4 = V_0;
		bool L_5 = Physics_Linecast_m1431720142(NULL /*static, unused*/, L_0, L_1, (RaycastHit_t1056001966 *)L_2, L_3, L_4, /*hidden argument*/NULL);
		V_1 = L_5;
		goto IL_0013;
	}
...
extern "C"  void Rigidbody_AddForce_m467379572 (Rigidbody_t3916780224 * __this, float ___x0, float ___y1, float ___z2, int32_t ___mode3, const RuntimeMethod* method)
{
	{
		float L_0 = ___x0;
		float L_1 = ___y1;
...
extern "C"  void Rigidbody_AddTorque_m3171849690 (Rigidbody_t3916780224 * __this, Vector3_t3722313464  ___torque0, const RuntimeMethod* method)
{
	int32_t V_0 = 0;
	{
		V_0 = 0;
		int32_t L_0 = V_0;
		Rigidbody_INTERNAL_CALL_AddTorque_m31996881(NULL /*static, unused*/, __this, (Vector3_t3722313464 *)(&___torque0), L_0, /*hidden argument*/NULL);
		return;
	}
}
// System.Void UnityEngine.Rigidbody::INTERNAL_CALL_AddTorque(UnityEngine.Rigidbody,UnityEngine.Vector3&,UnityEngine.ForceMode)
...
{
	{
		...
		Rigidbody_INTERNAL_CALL_AddForceAtPosition_m3698140343(NULL /*static, unused*/, __this, (Vector3_t3722313464 *)(&___force0), (Vector3_t3722313464 *)(&___position1), L_0, /*hidden argument*/NULL);
		return;
	}
}
// System.Void UnityEngine.Rigidbody::INTERNAL_CALL_AddForceAtPosition(UnityEngine.Rigidbody,UnityEngine.Vector3&,UnityEngine.Vector3&,UnityEngine.ForceMode)
